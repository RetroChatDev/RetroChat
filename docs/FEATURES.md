...
- Private conversations use **private rooms** (invite or password).
...
- Age attestation (16+), follow/unfollow, featured posts, identity badges.
...
- Age attestation on first sign-in (16+).
...
- Installable PWA on desktop and Android browsers.
- Native Android support continues to expand; use the PWA on Android today.
